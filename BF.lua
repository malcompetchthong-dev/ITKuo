...
if CoreGui:FindFirstChild("Ko-warning") then
	CoreGui["Ko-warning"]:Destroy()
end

local ScreenGui = Instance.new("ScreenGui", CoreGui)
ScreenGui.Name = "Ko-warning"
...
local ServerLink = "https://discord.gg/48SwgrjuT7"
local WarnMessage = "Kuo Hub is down for Now\njoin our discord for more information!"
